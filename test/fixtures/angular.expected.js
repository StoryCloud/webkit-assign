var __webkitAssign__$$watchers = "$$watchers", __webkitAssign__$$nextSibling = "$$nextSibling", __webkitAssign__$$childHead = "$$childHead", __webkitAssign__$$childTail = "$$childTail", __webkitAssign__$$listeners = "$$listeners", __webkitAssign__$$listenerCount = "$$listenerCount", __webkitAssign__$$watchersCount = "$$watchersCount", __webkitAssign__$id = "$id", __webkitAssign__$$ChildScope = "$$ChildScope", __webkitAssign__prototype = "prototype";function createChildScopeClass(parent) {
    function ChildScope() {
